...
$SED -e '/REQUIRE_ONCE/a %right T_LAMBDA_ARROW' \
     -e '/REQUIRE_ONCE/a %token T_LAMBDA_OP T_LAMBDA_CP T_PIPE_VAR T_TYPE T_NEWTYPE T_NULLSAFE' \
     -e '/REQUIRE_ONCE/a %left T_ENUM T_PIPE T_SHAPE T_VECTOR T_IMMVECTOR T_MAP T_IMMMAP T_SET T_IMMSET T_PAIR' \
